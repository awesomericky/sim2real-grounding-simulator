...
import imp
nets = imp.load_source("nets", "/home/awesomericky/racecar_ws/src/RCcar/scripts/GAT/nets.py")
    ...
    for epoch in range(start_iter, epochs):
        ...
        while ep_step < max_steps:
            ...
            while True:
                ...
                transformed_next_state = GAT_model.forward_transform(state, clipped_action)
                transformed_action = GAT_model.backward_transform(state, transformed_next_state)
